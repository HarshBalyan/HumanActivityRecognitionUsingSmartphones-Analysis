...
1)a<-variable which stores the tidy merged data
2)d<-the final tidy data
3)FinalOutput.txt<- file with the final output


List of feature in the data frame 'a'.
...
Columns added explicitly to the features are the Activity and the Subject columns.
The values for these columns is from the y_test/train.txt and subject_test/train.txt respectively.
